...
namespace Inheritance {
    public class Person {
        ...
        public Person(string name, DateTime birthDate, string birthPlace, string gender, string identityCardNumber) {
            this.Name = name;
        ...
        public Person(string name, DateTime birthDate, string birthPlace, string gender, string identityCardNumber, string religion, char bloodType, int height, double weight, string citizenship) {
            this.Name = name;
            this.BirthDate = birthDate;
            this.BirthPlace = birthPlace;
            this.Gender = gender;
